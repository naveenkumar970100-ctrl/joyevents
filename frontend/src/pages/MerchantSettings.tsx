...
import { Lock, User, Mail, ArrowLeft, Save, Eye, EyeOff } from "lucide-react";
   ...
   <MerchantLayout>
     <section className="py-2 sm:py-8 lg:py-10">
      <div className="container mx-auto">
         <Link to="/merchant-dashboard" className="mb-6 inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-primary">
